package dev.flab.simpleweather.aop;
...
public class LogAop {
    ...
    Post 요청 로깅
     */
    @Pointcut("@annotation(dev.flab.simpleweather.aop.PostMethodLog)")
    ...
    Get 요청 로깅
     */
    @Pointcut("@annotation(dev.flab.simpleweather.aop.GetMethodLog)")
